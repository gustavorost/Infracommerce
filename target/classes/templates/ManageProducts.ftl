		...
		<div class="panel-body">
	        <div class="formcontainer">
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-2 control-lable" for="value">Quantidade R$</label>
	                        <div class="col-md-7">
	                            <input type="number" ng-model="ctrl.product.quantidade" id="quantidade" class="form-control input-sm" placeholder="Digite a quantidade" required  ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" />
	                        </div>
	                    </div>
	                </div>
